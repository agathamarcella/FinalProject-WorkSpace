package com.agathamarcella.workspace.activities
...
import com.agathamarcella.workspace.R
import com.agathamarcella.workspace.adapter.MainAdapter
import com.agathamarcella.workspace.adapter.MainAdapterHorizontal
import com.agathamarcella.workspace.model.ModelMain
import com.agathamarcella.workspace.model.ModelMainHorizontal
import com.agathamarcella.workspace.networking.ApiEndpoint
import com.agathamarcella.workspace.utils.OnItemClickCallback
...
class MainActivity : AppCompatActivity(), LocationListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        searchResto.setQueryHint("Search")
    ...
    private fun showRecyclerResto() {
        ...
        mainAdapter?.setOnItemClickCallback(object : OnItemClickCallback {
            override fun onItemMainClicked(modelMain: ModelMain?) {
                ...
                intent.putExtra(DetailActivity.DETAIL_RESTO, modelMain)
        ...
        AndroidNetworking.get(ApiEndpoint.BASEURL + ApiEndpoint.CariResto + query + "&lat=" + lat + "&lon=" + lng + "&radius=20000")
            ...
            .getAsJSONObject(object : JSONObjectRequestListener {
                ...
                override fun onError(anError: ANError) {
                    mProgressBar?.dismiss()
                    Toast.makeText(this@MainActivity, "No internet network!", Toast.LENGTH_SHORT).show()
                }
            })
    }
