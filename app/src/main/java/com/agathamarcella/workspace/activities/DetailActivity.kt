...
import com.agathamarcella.workspace.adapter.HighlightsAdapter
import com.agathamarcella.workspace.model.ModelHighlights
            ...
            .getAsJSONObject(object : JSONObjectRequestListener {
                ...
                override fun onResponse(response: JSONObject) {
                    try {
                        ...
                        val Website = response.getString("url") + "/reviews"
                ...
                override fun onError(anError: ANError) {
                    mProgressBar?.dismiss()
                    Toast.makeText(this@DetailActivity,
                        "No internet network!", Toast.LENGTH_SHORT).show()
                }
            })
    }
